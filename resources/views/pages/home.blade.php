    ...
    <x-slot name="seo">
        ...
        @for ($i = 0; $i < count($locales); $i++)
            <link rel="alternate" 
                ...
                href={{ localized_route('home', [], $locales[$i]) }} />
        @endfor
        {{--
		...
		<div class="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
			<div class="mx-auto max-w-2xl text-center">
          		...
          		<div class="mt-10 flex items-center justify-center gap-x-6">
            		<a wire:navigate href="{{ localized_route('news') }}" class="justify-center rounded-md bg-slate-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
    	...
    	<div class="mx-auto max-w-7xl px-6 lg:px-8">
      	...
      	<div class="mt-16 flex justify-center">
        	<p class="relative rounded-full bg-gray-50 px-4 py-1.5 text-sm leading-6 text-gray-600 ring-1 ring-inset ring-gray-900/5">
            	...
            	<a wire:navigate href="{{ localized_route('news') }}" class="font-semibold text-indigo-600"><span class="absolute inset-0" aria-hidden="true"></span> Voir toute l'actualité jeu vidéo <span aria-hidden="true">&rarr;</span></a>
          	</p>
        </div>
    </div>
</x-app-layout>
